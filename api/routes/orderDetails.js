...
const router = express.Router();
  ...
  router.get('/:id', (req, res) => {
    ...
    customerquery='SELECT c.customerNumber, o.orderNumber , o.orderDate , o2.productCode, o2.quantityOrdered, customerName, contactLastName , contactFirstName FROM customers c INNER JOIN orders o on c.customerNumber = o.customerNumber Inner JOIN orderdetails o2 on o.orderNumber = o2.orderNumber ';
